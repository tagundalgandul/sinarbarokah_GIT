...
?>
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <form method="post" onsubmit="return formValidasi()" id='datatransaksi' name="tambahtransaksi">
                  ...
                  <div class="clearfix"></div>
                    <center>
                      ...
                      <input type="hidden" name="id_pengguna" value="<?php echo $_SESSION['ses_id'];?>"></input>
                        <div class="col-md-4">
                          <label>Tanggal</label>
                            <input type="date" value="<?php echo date('Y-m-d')?>" class="form-control" name="tanggal" placeholder="Tanggal penjualan" id="tgl">
                        </div>
                        <div class="col-md-4">
  ...
  <!-- /.content-wrapper -->
    ...
    function formValidasi(){
        var namapelanggan = document.tambahtransaksi.pelanggan;
        var qty = $('#qty').val();
        var angka = /^[0-9]+$/;

        if (pelanggan.selectedIndex < 1) {
