        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <form  method="POST" onsubmit="return formValidasi()" name="tambahpromosi">
                <table class="table table-hover">
                  <div class="form-group">
                    <tr>
                      <td>
                        ...
                        <div class="col-sm-10">
                          <input type="text" class="form-control" name="isi_promosi"  placeholder="Promosi" id="isipromosi">
                        </div>
                      </td>
                    </tr>
                  </div>
                  <div class="form-group">
                    <tr>
                      <td>
                        ...
                        <div class="col-sm-10">
                          <input type="date" class="form-control" name="tgl_berlaku"  placeholder="Tanggal Berlaku" id="tglberlaku">
                        </div>
                      </td>
                    </tr>
                  </div>
                  <div class="form-group">
                    <tr>
                      <td>
                        ...
                        <div class="col-sm-10">
                          <input type="date" class="form-control" name="tgl_berakhir"  placeholder="Tanggal Berakhir" id="tglberakhir">
                        </div>
                      </td>
                    </tr>
                  </div>
                 ...
                 <button type="submit" name="tambah_promosi" class="btn btn-primary " value="submit">Save</button>
                  </center>
              </form>
            </div>
          <!-- /.box -->
