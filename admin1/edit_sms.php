            ...
            <div class="box-header">
              <form  method="POST">
                <table class="table table-hover">
                  <div class="form-group">
                    <tr>
                      <td>
                        ...
                        <div class="col-sm-10">
                          <input type="text" class="form-control" name="isi_sms" value="<?php echo $data['isi_sms']; ?>"  placeholder="isi sms">
                        </div>
                      </td>   
                  </div>
                </table>
                 ...
                 <button type="submit" name="edit-sms" class="btn-primary " value="submit">Save</button>
                  </center>
              </form>
            </div>
          <!-- /.box -->
