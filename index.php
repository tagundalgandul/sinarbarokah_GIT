				...
				<div class="container">
					<div class="navbar-header">
						...
						<div class="navbar-brand">
							<a href="index.php"><h1><span>SINAR</span>BAROKAH</h1></a><br>
                        ...
                        <div class="row slide-margin">
                            <div class="col-sm-6">
                                <div class="carousel-content">
                                    <h2 class="animation animated-item-1">Welcome <span>SINAR BAROKAH</span></h2>
                                    <p class="animation animated-item-2"></p>
                                    <a class="btn-slide animation animated-item-3" href="info-perusahaan.php">Read More</a>
                                </div>
                            </div>
